   ...
   <div class="about_section layout_padding">
      <div class="container">
         <div class="about_section_main">
            <div class="row">
               <div class="col-md-6">
                  <div><img src="${contextPath}/resources/recom_codi/codi_1342.jpg" class="image_3"></div>
               </div>
               <div class="col-md-6">
                  <div class="about_taital_main">
                     <h1 class="about_taital">확신한 존재감</h1>
                     <p class="about_text" style="font-size:21px;">스웨트셔츠에 폴리스 베스트를 레이어드한 후 카키 숏 패딩으로 완성한 캐주얼 룩</p>
                  ...
                  <div class="about_taital_main">
                     <div class="slider-2">
                        ...
                        <div class="slides">
                           <div class="active" style="background-image:url(${contextPath}/resources/recom_codi_detail/962116.jpg);"></div>

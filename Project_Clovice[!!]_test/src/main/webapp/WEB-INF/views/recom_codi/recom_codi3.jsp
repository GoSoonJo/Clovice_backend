   ...
   <div class="about_section layout_padding">
      <div class="container">
         <div class="about_section_main">
            <div class="row">
               <div class="col-md-6">
                  <div><img src="${contextPath}/resources/recom_codi/codi_13021.jpg" class="image_3"></div>
               </div>
               <div class="col-md-6">
                  <div class="about_taital_main">
                     <h1 class="about_taital">캠퍼스 룩 추천</h1>
                     <p class="about_text" style="font-size:21px;">심플한 디자인의 긴팔 티셔츠와 데님 팬츠를 코디하고 블루종으로 완성한 캐주얼 룩</p>
                  ...
                  <div class="about_taital_main">
                     <div class="slider-2">
                        ...
                        <div class="slides">
                           <div class="active" style="background-image:url(${contextPath}/resources/recom_codi_detail/1635328.jpg);"></div>

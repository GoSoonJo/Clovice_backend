   ...
   <div class="about_section layout_padding">
      <div class="container">
         <div class="about_section_main">
            <div class="row">
               <div class="col-md-6">
                  <div><img src="${contextPath}/resources/recom_codi/codi_10612.jpg" class="image_3"></div>
               </div>
               <div class="col-md-6">
                  <div class="about_taital_main">
                     <h1 class="about_taital">스트라이프 포인트</h1>
                     <p class="about_text" style="font-size:21px;">스트라이프 패턴이 매력적인 긴팔 티셔츠와 폴리스 재킷을 매치하고 숏 패딩으로 완성한 캐주얼 룩</p>
                  ...
                  <div class="about_taital_main">
                     <div class="slider-2">
                        ...
                        <div class="slides">
                           <div class="active" style="background-image:url(${contextPath}/resources/recom_codi_detail/1349501.jpg);"></div>

   ...
   <div class="about_section layout_padding">
      <div class="container">
         <div class="about_section_main">
            <div class="row">
               <div class="col-md-6">
                  <div><img src="${contextPath}/resources/codi/codi_12251.jpg" class="image_3"></div>
               </div>
               <div class="col-md-6">
                  ...
                  <div class="about_taital_main">
                     <div class="slider-2">
                        ...
                        <div class="slides">
                           <div class="active" style="background-image:url(${contextPath}/resources/product2/987079_4.jpg);"></div>

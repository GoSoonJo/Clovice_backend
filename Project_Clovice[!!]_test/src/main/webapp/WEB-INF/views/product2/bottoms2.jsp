   ...
   <div class="about_section layout_padding">
      <div class="container">
         <div class="about_section_main">
            <div class="row">
               <div class="col-md-6">
                  <div><img src="${contextPath}/resources/codi/codi_8600.jpg" class="image_3"></div>
               </div>
               <div class="col-md-6">
                  <div class="about_taital_main">
                     <h1 class="about_taital">매력적인 코디</h1>
                     <p class="about_text">비건디 컬러가 돋보이는 스웨트셔츠와 데님 팬츠를 매치하고 슬링 백으로 마무리한 캐주얼 룩</p>
                  ...
                  <div class="about_taital_main">
                     <div class="slider-2">
                        ...
                        <div class="slides">
                           <div class="active" style="background-image:url(${contextPath}/resources/product2/1219189_1.jpg);"></div>

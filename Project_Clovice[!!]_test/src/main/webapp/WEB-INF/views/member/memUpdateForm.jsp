				...
				<input id="memPassword" type="hidden" name="memPassword" value=""/>
					<table class="table table-bordered" style="text-align: center; border: 1px solid #dddddd">
						...
						<tr>
							...
							<td colspan="2"><input id="memName" name="memName" type="text" class="form-control" placeholder="이름을 입력하세요" maxlength="20" value="${mvo.memName}"/></td>
						</tr>
						<tr>
							<td style="width: 110px; vertical-align: middle;">나이</td>
							<td colspan="2"><input id="memAge" name="memAge" type="number" class="form-control" placeholder="나이를 입력하세요" maxlength="20" value="${mvo.memAge}"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="2">
							<input id="memEmail" name="memEmail" type="text" class="form-control" placeholder="이메일을 입력하세요" maxlength="50" value="${mvo.memEmail}"/>
							</td>
						</tr>
						<tr>
